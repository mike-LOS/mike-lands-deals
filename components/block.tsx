...
function PureBlock({
  ...
  const handleVersionChangeAction = async (type: 'next' | 'prev' | 'toggle' | 'latest') => {
    if (!documents) return;
  ...
  const handleSetToolbarVisible = async (visible: boolean) => {
  ...
  const handleSetMessages = async (messages: Message[] | ((messages: Message[]) => Message[])) => {
          ...
          >
            ...
            >
              ...
              >
                ...
                ) : block.kind === 'code' || block.kind === 'text' ? (
                  <CodeEditor
                    content={
                      isCurrentVersion
                        ? block.content
                ...
                <AnimatePresence>
                  {isCurrentVersion && (
                    <Toolbar
                      ...
                      setIsToolbarVisibleAction={handleSetToolbarVisible}
                      appendAction={append}
                      isLoading={isLoading}
                      stopAction={handleStop}
                      setMessagesAction={handleSetMessages}
